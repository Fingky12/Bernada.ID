...
<div class="stats-bar">
  <div class="stats-inner">
    <div class="stat-item"><div class="num">500+</div><div class="label">Undangan dibuat</div></div>
    <div class="stat-item"><div class="num">6+</div><div class="label">Tema tersedia</div></div>
    <div class="stat-item"><div class="num">4.9★</div><div class="label">Rating pengguna</div></div>
    <div class="stat-item"><div class="num">24 jam</div><div class="label">Waktu proses</div></div>
  </div>
</div>
