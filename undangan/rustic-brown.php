...
$pria    = $data['nama_pria']     ?? 'Raka';
$wanita  = $data['nama_wanita']   ?? 'Dira';
$tgl_raw = $data['tanggal_nikah'] ?? '2026-10-10';
$wm      = $data['waktu_mulai']   ?? '09:00';
$ws      = $data['waktu_selesai'] ?? '13:00';
$lokasi  = $data['lokasi']        ?? 'Villa Kebun Kopi, Batu Malang';
      ...
      <div class="sec-inner">
        ...
        <div class="event-cards">
          <div class="event-card">
            ...
            <div class="event-row"><span class="ico"><i class='bx bx-time'></i></span><strong>Waktu</strong><span><?= $wm ?> WIB – Selesai</span></div>
          ...
          <div class="event-card">
            ...
            <div class="event-row"><span class="ico"><i class='bx bx-calendar'></i></span><strong>Tanggal</strong><span><?= $tgl_full ?></span></div>
            <div class="event-row"><span class="ico"><i class='bx bx-time'></i></span><strong>Waktu</strong><span><?= $wm ?> – <?= $ws ?> WIB</span></div>
            <div class="event-row"><span class="ico"><i class='bx bx-map-pin' ></i></span><strong>Lokasi</strong><span><?= $lokasi ?></span></div>
            <a href="<?= $maps ?>" target="_blank" class="btn-maps"><i class='bx bx-map'></i> Buka Google Maps</a>
          </div>
        </div>
      ...
      <div class="sec-inner">
        ...
        <div class="amplop-grid">
          <div class="amplop-card">
            <div class="amplop-bank-logo"><i class='bx bxl-bca'></i></div>
            <h3>Bank BCA</h3>
          ...
          <div class="amplop-card">
            <div class="amplop-bank-logo">💳</div>
            <h3>GoPay / OVO</h3>
